...
namespace csMACnz.Consolable.Tests
{
    public class UsageTests
    {
        ...
        public void BareBonesHelpTest()
        {
            ...
            var args = ShellArgsParser.Parse("-?");
        ...
        {
            // Simulate .Net args parsing
            var args = ShellArgsParser.Parse("-a -b Value -c Item1 Item2 -de --flag --green true");
            var rules = new IRule[]
            {
        ...
        private static void AssertContainsKeyWithBoolValueTrue(Dictionary<string, object> values, string key)
        {
