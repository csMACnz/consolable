...
namespace csMACnz.Consolable.Tests.ValidatorTests
{
    public class GivenOneRequiredFlagAndOneRequiredSingleValue
    {
        ...
        [Fact]
        public void ValidateArguments_MissingSingleValueTokenThenValidArgument_OneError()
        {
        ...
        [Fact]
        public void ValidateArguments_ValidArgumentThenMissingSingleValueToken_OneError()
        {
